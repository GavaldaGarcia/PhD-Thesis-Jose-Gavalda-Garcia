...
\section*{\textcolor{red}{Aims of this chapter}}
\begin{itemize}
...
% \textcolor{red}{In this work, Dr. David Bickel and I collaborated to develop, validate and understand the data-driven, probabilistic definition of conformational state propensities and conformational state variability here described. We jointly created and published a Python program, Constava, with our implementation of the method, the pre-trained probability density functions describing our proposed conformational states, and a variety of functionalities to tailor the method and its outputs to answer diverse scientific questions. }
