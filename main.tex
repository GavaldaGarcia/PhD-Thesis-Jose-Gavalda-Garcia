...
\usepackage[toc, nonumberlist, section=chapter]{glossaries}
% \usepackage{xr}
\usepackage{pdfpages}
...
% % include cover
% \includepdf[pages=-]{20241008_v5_Thesis_cover_jgg_only_front.pdf} 
% % SUPPRESS PAGE NUMBER FOR NEXT PAGE
% \thispagestyle{empty} % Removes page numbering for this page
% \clearpage % Move to the next page cleanly
...
\include{preamble/acknowledgements_filled}
\newpage
